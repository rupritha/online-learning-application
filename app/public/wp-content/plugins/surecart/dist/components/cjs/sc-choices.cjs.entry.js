...
const ScChoices = class {
    ...
    render() {
        return (index.h("fieldset", { key: '2c3309395b3ecadfcb4a6be170e1c33dcbeeec68', part: "base", class: {
                'choices': true,
            ...
            }, role: "radiogroup" }, index.h("sc-form-control", { key: 'c8eefb3cdab51dd19619a599d57c0bcce86c4e93', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, showLabel: this.showLabel, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId }, index.h("div", { key: '3226c4ffdb15805eccc7e7528dd94fb4c956592d', part: "choices", class: "choices__items" }, index.h("slot", { key: '7abf94b34e98590f443e8c2f63de7fb29f54f7d0' })))));
    }
