...
const ScSubscriptionPaymentMethod = class {
    ...
    render() {
        var _a;
        return (index.h("sc-dashboard-module", { key: 'ff20bdf6cf0e0db193260cee6349eb1460040646', heading: this.heading || wp.i18n.__('Update Payment Method', 'surecart'), class: "subscription", error: this.error }, index.h("sc-button", { key: '4c4ab1b3f78a00f1fa1a77209bb27678c69a73cf', slot: "end", type: "link", href: addQueryArgs.addQueryArgs(window.location.href, {
                action: 'create',
                model: 'payment_method',
                ...(((_a = this.subscription) === null || _a === void 0 ? void 0 : _a.live_mode) === false ? { live_mode: false } : {}),
                success_url: window.location.href,
            }) }, index.h("sc-icon", { key: 'd1cc9365f2ed704049c03468e85e9325361ced3e', name: "plus", slot: "prefix" }), wp.i18n.__('Add New', 'surecart')), this.renderContent(), this.busy && index.h("sc-block-ui", { key: '8687c50f08d169d54543450c58f4cb2b9aedfb5a', spinner: true })));
    }
