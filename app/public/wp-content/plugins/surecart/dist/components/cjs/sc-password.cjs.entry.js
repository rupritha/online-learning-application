...
const ScPassword = class {
    ...
    render() {
        var _a;
        return (index.h("div", { key: 'ba50f88b08e6098cf74842d570066bb428f107fb', class: "password" }, index.h("div", { key: '1cccdd4171dc83071bbf77ff1884e6e4cd0f41d5' }, index.h("sc-input", { key: 'e3258a44dab62e58f414a15fbff8b5d2be0e3ffa', ref: el => (this.input = el), label: this.label, help: this.help, autofocus: this.autofocus, placeholder: this.placeholder, showLabel: this.showLabel, size: this.size ? this.size : 'medium', type: "password", name: "password", value: this.value, required: this.required, disabled: this.disabled, onScInput: () => this.handleValidate() }), !!this.hintText && index.h("small", { key: 'f595933d72a3a96873ad10a046a8843d149a8fea', class: "password__hint" }, this.hintText)), this.confirmation && (index.h("div", { key: 'dc925d7f3fc73c7d19b6e29bf0687909cb3a9ac4' }, index.h("sc-input", { key: 'dab9e9d4ff049df78775d11690e31a918c9b9bb8', ref: el => (this.confirmInput = el), label: (_a = this.confirmationLabel) !== null && _a !== void 0 ? _a : wp.i18n.__('Confirm Password', 'surecart'), help: this.confirmationHelp, placeholder: this.confirmationPlaceholder, size: this.size ? this.size : 'medium', type: "password", value: this.value, onScInput: () => this.handleVerification(), required: this.required, disabled: this.disabled }), !!this.verifyText && index.h("small", { key: 'a0f94d6fbbfcd07fb5cb51720a476e22ca4ed393', class: "password__hint" }, this.verifyText)))));
    }
