...
const ScPurchaseDownloadsList = class {
    ...
    render() {
        return (h("sc-dashboard-module", { key: '3a9b81f0abb839677486bfa6d333329f85278cd2', class: "downloads-list", error: this.error }, h("span", { key: '205d92ab1f526c904fbd3073df896270368505d4', slot: "heading" }, h("slot", { key: 'd0b7af644b0f97a81e0e1619e19a6ac12a1b896a', name: "heading" }, this.heading || wp.i18n.__('Items', 'surecart'))), h("slot", { key: 'fedefcd54579750be80fdcc76202af17f3857bff', name: "before" }), !!this.allLink && (h("sc-button", { key: '7f9f593784349259267283581e53ed8b28cb0998', type: "link", href: this.allLink, slot: "end" }, wp.i18n.__('View all', 'surecart'), h("sc-icon", { key: '0e31180f1b77b59cf070323779584be27b4f72f3', name: "chevron-right", slot: "suffix" }))), this.renderContent(), h("slot", { key: '917f641432652c0e9bbf6803e465ed21a27394ad', name: "after" }), this.busy && h("sc-block-ui", { key: '3a79ae70ff4181b1155eb787e869db7690063b8b' })));
    }
