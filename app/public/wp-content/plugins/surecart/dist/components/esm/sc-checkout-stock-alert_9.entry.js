...
const ScFormComponentsValidator = class {
    ...
    render() {
        return h("slot", { key: 'ffa4e16f5dbd6431d126e66f19c084ac670453a5' });
    }
    get el() { return getElement(this); }
    static get watchers() { return {
...
const ScFormErrorProvider = class {
    ...
    render() {
        return h("slot", { key: '188ca791b22d6b3cd5d287ca894c56a8c586ec32' });
    }
    get el() { return getElement(this); }
};
...
const ScLoginProvider = class {
    ...
    render() {
        return (h(Host, { key: '8014fe070d6ff9e549a05bd4553bc1dda857a0d1' }, !!this.notice && (h("sc-alert", { key: '30f46cfbd4a612fa31d723f9534710b2b436ee72', type: "success", open: true, style: { marginBottom: 'var(--sc-form-row-spacing)' }, closable: true }, h("span", { key: 'e91f815297341ee0a35434a2eea9e6e987d7c523', slot: "title" }, wp.i18n.__('Welcome back!', 'surecart')), wp.i18n.__('You have logged in successfully.', 'surecart'))), h("slot", { key: 'e0ee0b7827947b3305aae239eef7b7d069fd9eb2' }), !this.loggedIn && (h("sc-dialog", { key: '208756c6bbf8f3be170381af43d1267877c75211', label: wp.i18n.__('Login to your account', 'surecart'), open: this.open, onScRequestClose: () => (this.open = false) }, h("sc-form", { key: '2712438d61cd4f2839cd9a1f73c5c965e6933111', ref: el => (this.loginForm = el), onScFormSubmit: e => {
                e.preventDefault();
                e.stopImmediatePropagation();
            }, onScSubmit: e => this.handleFormSubmit(e) }, !!this.error && (h("sc-alert", { key: 'bb145adca21a321cc85e4487f2efe5116dc59dea', type: "danger", open: !!this.error }, this.error)), h("sc-input", { key: '6ede6aaa5268c3e9fd219f64550656e77f404792', label: wp.i18n.__('Email or Username', 'surecart'), type: "text", name: "login", required: true, autofocus: this.open }), h("sc-input", { key: '634c319c956d71b18f2050f407aad7dae7d9d934', label: wp.i18n.__('Password', 'surecart'), type: "password", name: "password", required: true }), h("sc-button", { key: '53a50f1ef8f3104bbcbe8bd054fb29f5e9b0a5c3', type: "primary", full: true, loading: this.loading, submit: true }, wp.i18n.__('Login', 'surecart')))))));
    }
    static get watchers() { return {
...
const ScOrderConfirmProvider = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'e17d129128bf05add71113fc115b92c17dc12b74' }, h("slot", { key: '45179c7e1c07bac9ef0b34a59d622f7a30982071' }), h("sc-dialog", { key: 'b0ca89c1a2a1c47a986431215bcc062915f3bea3', open: !!this.showSuccessModal, style: { '--body-spacing': 'var(--sc-spacing-xxx-large)', '--width': '400px' }, noHeader: true, onScRequestClose: e => e.preventDefault() }, h("div", { key: 'f4fe46c01f30b11af7b50487d72edd477e5764f5', class: "confirm__icon" }, h("div", { key: '14a96edc00c05f087e64144e0ff9f90a5893e506', class: "confirm__icon-container" }, h("sc-icon", { key: 'ea0a32c352fdbecbf5de986a9ed2349c5b828fd0', name: "check" }))), h("sc-dashboard-module", { key: 'ee040151e6df3c89cbc7f6695adcc11f202f7886', heading: ((_b = (_a = state$3 === null || state$3 === void 0 ? void 0 : state$3.text) === null || _a === void 0 ? void 0 : _a.success) === null || _b === void 0 ? void 0 : _b.title) || wp.i18n.__('Thanks for your order!', 'surecart'), style: { '--sc-dashboard-module-spacing': 'var(--sc-spacing-x-large)', 'textAlign': 'center' } }, h("span", { key: '96e8849804d6508bc0624781c01c591d12c9ba3e', slot: "description" }, ((_d = (_c = state$3 === null || state$3 === void 0 ? void 0 : state$3.text) === null || _c === void 0 ? void 0 : _c.success) === null || _d === void 0 ? void 0 : _d.description) || wp.i18n.__('Your payment was successful. A receipt is on its way to your inbox.', 'surecart')), !!((_e = this.manualPaymentMethod) === null || _e === void 0 ? void 0 : _e.name) && !!((_f = this.manualPaymentMethod) === null || _f === void 0 ? void 0 : _f.instructions) && (h("sc-alert", { key: '7a1e5668f77f9068fccf14eb4438e12d91513a2b', type: "info", open: true, style: { 'text-align': 'left' } }, h("span", { key: 'f87684ca0e296c18c7a2fa7c3b7e4f9884bed78f', slot: "title" }, (_g = this.manualPaymentMethod) === null || _g === void 0 ? void 0 : _g.name), h("div", { key: '44fc901029b1dbd36e5c49ce5eff0c9f4641f2af', innerHTML: (_h = this.manualPaymentMethod) === null || _h === void 0 ? void 0 : _h.instructions }))), h("sc-button", { key: 'edc305fbf3dad3c6b3ae884ba4b3bbc0db2e0b68', href: this.getSuccessUrl(), size: "large", type: "primary", ref: el => (this.continueButton = el) }, ((_k = (_j = state$3 === null || state$3 === void 0 ? void 0 : state$3.text) === null || _j === void 0 ? void 0 : _j.success) === null || _k === void 0 ? void 0 : _k.button) || wp.i18n.__('Continue', 'surecart'), h("sc-icon", { key: '76b9667cf29400a466d8fcdcac407db3e2440cdd', name: "arrow-right", slot: "suffix" }))))));
    }
    get el() { return getElement(this); }
    static get watchers() { return {
        "checkoutStatus": ["handleConfirmOrderEvent"],
...
const ScSessionProvider = class {
    ...
    render() {
        return (h("sc-line-items-provider", { key: '19f92624ca51b6e003c3b9f15a6084369805e1cb', order: state === null || state === void 0 ? void 0 : state.checkout, onScUpdateLineItems: e => this.loadUpdate({ line_items: e.detail }) }, h("slot", { key: 'ede00bd7614ef44738e1cf5bbc168c869e44c91e' })));
    }
    get el() { return getElement(this); }
    static get watchers() { return {
